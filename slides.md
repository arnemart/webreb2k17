...
> the audience. This talk, however, will plobably be anything but relevant for most of
...
> people like us -- javascript is not what you would call "beloved". It has its charms,
> but it also has a lot of quirks, and a large amount of
...
> There's typescript from Microsoft, if you like writing JS but want some type safety
...
> If you like Haskell, there's Elm
...
> overview of a common setup. More on each of these steps in a moment.
...
> The lexer or tokenizer reads the source code and generates tokens. This is a simple list of
> every part of the program, basically a strict representation of the text string of the program.
> The tokens then go into syntactical analasys to produce the AST.
...
> The AST is a data structure that represents every part of the program. The list of tokens
> is parsed and turned into a recursive data structure that is syntactically valid. If there are
> syntax errors in the code, like unbalanced parens and stuff, this is usually where they are
> discovered.
